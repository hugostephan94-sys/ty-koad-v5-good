...
export const CHALETS = {
  ...
  C2: {
    ...
    priceWeekend: 150,        // ven-sam
    priceWeek: 130,           // dim-jeu
    minNights: 1,
    deposit: 500,
    animalsAllowed: true,
    externalOnly: false,       // pour l’instant : Booking uniquement
    bookingUrl: "https://www.booking.com/", // Mets l’URL exacte quand ce sera en ligne
